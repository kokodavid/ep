...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["changepassword-changepassword-module"], {
  ...
  function srcAppChangepasswordChangepasswordPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ChangepasswordPage(authService, route, router, navCtrl, alertService) {
        var _this = this;
        ...
        this.alertService = alertService; // this.feedback = new Array();

        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            _this.data = _this.router.getCurrentNavigation().extras.state.details;
            console.log(_this.data); // t his.school = this.data.school;
          }
        });
      ...
      _createClass(ChangepasswordPage, [{
        ...
        key: "managenewPassword",
        value: function managenewPassword() {
          if (this.showNewText === 0) {
            this.showNewText = 1;
            this.newtype = 'text'; // console.log(this.showPasswordText);
          } else if (this.showNewText === 1) {
            this.showNewText = 0;
            this.newtype = 'password'; // console.log(this.showPasswordText);
          }
        }
      }, {
        key: "reset",
        value: function reset(form) {
          ...
          if (form.value.newpassword.length < 8 || !/\d/.test(form.value.newpassword)) {
            ...
            this.sameAsOld = false;
            this.notSame = false;
            this.authService.reset(form.value.oldpass, form.value.newpassword).subscribe(function (data) {
              _this2.response = data;
              console.log(_this2.response);

              if (_this2.response.response === 'success') {
                _this2.authService.dismiss();

                _this2.alertService.presentToast('Password changed successfully...');

                _this2.navCtrl.navigateRoot('/dashboard');
              } else {
                _this2.authService.dismiss();

                _this2.authService.presentAlert1(_this2.response.data);
              }
            }, function (error) {
              _this2.authService.dismiss();
    ...
    ChangepasswordPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/changepassword/changepassword.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./changepassword.page.scss */
      "./src/app/changepassword/changepassword.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"], src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"]])], ChangepasswordPage);
    /***/
  }
}]);
