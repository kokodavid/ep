...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-student-attendance-attendance-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesStudentAttendanceAttendancePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentAttendanceAttendanceModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    AttendancePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesStudentAttendanceAttendancePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentAttendanceAttendancePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function AttendancePage(authServices, router, route, sessionService) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            _this.student = _this.router.getCurrentNavigation().extras.state.details.student_name;
            _this.student_id = _this.router.getCurrentNavigation().extras.state.details.student_id;
            _this.sub_domain = _this.router.getCurrentNavigation().extras.state.details.school_subdomain;
            _this.class_name = _this.router.getCurrentNavigation().extras.state.details.class_name;
            _this.details = _this.router.getCurrentNavigation().extras.state.details;

            if (_this.sub_domain == null) {
              _this.sub_domain = _this.router.getCurrentNavigation().extras.state.details.school;
      ...
      _createClass(AttendancePage, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.authServices.getAbsenteeism(this.student_id, this.sub_domain).subscribe(function (days) {
                      _this2.data = days;

                      if (_this2.data.response === "success") {
                        _this2.absent_days = _this2.data.data === undefined ? [] : _this2.data.data;
                        console.log(_this2.absent_days); //duration

                        for (var i = 0; i < _this2.absent_days.length; i++) {
                          var oneDay = 24 * 60 * 60 * 1000;
                          var from = new Date(_this2.data.data[i].starting);
                          var to = new Date(_this2.data.data[i].ending);

                          _this2.starting_dates.push(moment__WEBPACK_IMPORTED_MODULE_4__(from).format('MMM, Do YYYY'));

                          console.log(_this2.starting_dates);

                          _this2.month.push(_this2.getMonth(from));
                          ...
                          _this2.duration.push(total_days - weekend);
                        }
                      }
                    });
        ...
        key: "reportAbsent",
        value: function reportAbsent(absentForm) {
          var _this3 = this;
          ...
          if (end.getTime() > start.getTime()) {
            if (!this.starting_dates.includes(moment__WEBPACK_IMPORTED_MODULE_4__(start).format('MMM, Do YYYY'))) {
              this.authServices.reportAbsenteeism(this.student_id, absentForm.value.message, absentForm.value.reason, absentForm.value.from_date, absentForm.value.to_date, this.sub_domain, starting, ending).subscribe(function (data) {
                _this3.data = data;

                if (_this3.data.response === "success") {
                  _this3.authServices.presentAlert2(_this3.data.data);
                  ...
                  _this3.router.navigate(['home'], navigationExtras);
                } else {
                  _this3.authServices.presentAlert2(_this3.data.data);
                }
              });
            ...
            absentForm.reset();
            document.querySelector("app-attendance").querySelector('ion-content').scrollToTop(1500); // absentForm.value.from_date = '';
        ...
        key: "checkWeekend",
        value: function checkWeekend(date1, date2) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('absentForm', {
      "static": false
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgForm"])], AttendancePage.prototype, "absentForm", void 0);
    AttendancePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-attendance',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./attendance.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/student/attendance/attendance.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./attendance.page.scss */
      "./src/app/pages/student/attendance/attendance.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], src_app_services_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"]])], AttendancePage);
    /***/
  }
}]);
//# sourceMappingURL=pages-student-attendance-attendance-module-es5.js.map