...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-news-news-module"], {
  ...
  function srcAppPagesNewsNewsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NewsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"]],
  ...
  function srcAppPagesNewsNewsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function NewsPage(transfer, spinnerDialog, file, fileOpener, navCtrl, authService, route, router, sessionService, streamingMedia, sanitizer, http, iab, alertService, adHTTP, document, platform) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            _this.newsinfo = _this.router.getCurrentNavigation().extras.state.details;
            ...
            if (_this.newsinfo === null || _this.newsinfo === undefined) {
              _this.navCtrl.navigateRoot('/dashboard');
            } else {
              var filename = _this.newsinfo.attachment ? _this.newsinfo.attachment : null;
              ...
              console.log("here" + JSON.stringify(_this.newsinfo));
      ...
      _createClass(NewsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.http.get("https://api.eduweb.co.ke/getParticularCommunication/".concat(this.school, "/").concat(this.student_id, "/").concat(this.newsinfo.com_id)).subscribe(function (response) {
        ...
        value: function open(file) {
          ...
          this.fileOpener.showOpenWithDialog(file, fileMIMEType).then(function () {
            ...
            _this2.alertService.presentToast(e);
          });
        }
      }, {
        key: "download",
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    trans.download(url, path + fileName, true).then(function (entry) {
                      ...
                      _this3.open(downUrl); // this.document.viewDocument(url,'application/pdf',{});
        ...
        key: "openFileHandler",
        value: function openFileHandler() {
          this.fileOpener.open(this.downloadFile, '').then(function () {
            return console.log('File is opened');
          })["catch"](function (e) {
