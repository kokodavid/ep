...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HomePage(route, router, navCtrl, authService) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            ...
            _this.resource = _this.router.getCurrentNavigation().extras.state.resources;

            if (_this.data === null || _this.data === undefined) {
              _this.navCtrl.navigateRoot('/dashboard');
            } else {
              _this.school = _this.data.school;
              _this.assets = "https://".concat(_this.school, ".eduweb.co.ke/assets/students/");
            }
          }
        });
      }
      ...
      _createClass(HomePage, [{
        ...
        key: "details",
        value: function details(student) {
          // console.log(student);
          var navigationExtras = {
            state: {
              details: student
        ...
        key: "cbcgrades",
        value: function cbcgrades(student) {
          //term ids
          // this.term_ids = [];
          // this.class_id = [];
          // for (var c of this.terms) {
        ...
        key: "analytics",
        value: function analytics(student) {
          var navigationExtras = {
            state: {
              details: student
            }
        ...
        key: "attendance",
        value: function attendance(student) {
          var navigationExtras = {
            state: {
              details: student
            }
        ...
        key: "resources",
        value: function resources(student) {
          var navigationExtras = {
            state: {
              details: student,
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])], HomePage);
    /***/
  }
}]);
