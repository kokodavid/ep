...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-reports-grades-grades-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesReportsGradesGradesPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesReportsGradesGradesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesReportsGradesGradesPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesReportsGradesGradesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    "./src/app/services/session.service.ts"); // import { mkdir } from 'fs';


    var GradesPage =
    /*#__PURE__*/
    function () {
      function GradesPage(route, router, authService, fileOpener, sessionService) {
        var _this = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            ...
            _this.type = _this.router.getCurrentNavigation().extras.state.examTypes;
            _this.term_id = _this.router.getCurrentNavigation().extras.state.term_id;
            _this.cbc = _this.router.getCurrentNavigation().extras.state.type;
            _this.class_id = _this.router.getCurrentNavigation().extras.state.class_id;
            _this.schoolInfo = _this.router.getCurrentNavigation().extras.state.schoolInfo;
            ...
            _this.sessionService.sessionTimeOut();

            _this.col1 = _this.examTypes.length; // get headers

            console.log(_this.schoolInfo);
            var schoolDetails = {};

            _this.schoolInfo.forEach(function (element) {
              if (element.name === 'Letterhead') {
                if (element.name === 'Letterhead' || element.name === 'logo' || element.name === 'School Name' || element.name === 'Address 2' || element.name === 'Address 1' || element.name === 'Phone Number' || element.name === 'Email Address' || element.name === 'Phone Number 2') {
                  // console.log(element.name, element.value);
                  if (element.name === 'Letterhead') {
                    var Letterhead = element.value; // if(Letterhead == undefined || Letterhead == null){
                    //   schoolDetails['head']= ``
                    // }

                    schoolDetails['head'] = Letterhead;
                  } else if (element.name === 'logo') {
                    var Logo = element.value;
                    schoolDetails['Logo'] = Logo;
                    console.log(Logo);
                  } else if (element.name === 'School Name') {
                    var schoolname = element.value;
            ...
            _this.schoolHeaders = schoolDetails;
            console.log(_this.schoolHeaders);
            _this.usehead = _this.schoolHeaders.head ? 1 : 0;
            _this.header = "https://".concat(_this.student.school, ".eduweb.co.ke/assets/schools/").concat(_this.schoolHeaders.head);
            _this.header1 = "https://".concat(_this.student.school, ".eduweb.co.ke/assets/schools/").concat(_this.schoolHeaders.head);
            console.log(_this.header, _this.header1);
            console.log(_this.reportCards.report_card_comments);
            _this.comments = _this.reportCards.report_card_comments;

            if (_this.reportCards.exam_marks == null) {
              _this.exam_marks = [" "];
            } else {
            ...
            _this.opening_date = _this.reportCards.next_term_begins;
            _this.closing_date = _this.reportCards.closing_date; // subjects

            _this.sub = _this.reportCards.subjects_column == undefined ? [] : _this.reportCards.subjects_column; // exam types

            console.log(_this.reportCards);
            var exam = []; // tslint:disable-next-line:prefer-for-of

            for (var a = 0; a < _this.exam_marks.length; a++) {
              // tslint:disable-next-line: prefer-for-of
              for (var b = 0; b < _this.exam_marks[a].exam_marks.length; b++) {
                // console.log(this.exam_marks[a].exam_marks[b].mark);
                if (_this.exam_marks[a].exam_marks[b].mark !== null) {
                  exam.push(_this.exam_marks[a].exam_type); // this.exam_type['exam_type'] = this.exam_marks[a].exam_type;
                }
              }
            }

            _this.exam_type = exam.filter(_this.onlyUnique); // overall
            // tslint:disable-next-line: max-line-length

            _this.subjOvrl = _this.reportCards.subject_overalls_column[0].subject_overalls == undefined ? [] : _this.reportCards.subject_overalls_column[0].subject_overalls; // exam grades

            if (_this.exam_marks[0] !== undefined) {
              _this.cat1 = _this.exam_marks[0].exam_marks === undefined ? [] : _this.exam_marks[0].exam_marks;
              var c = [];

              _this.cat1.filter(function (params) {
                c.push(params.mark);
                return c != null;
              });
            ...
            if (_this.exam_marks[1] !== undefined) {
              _this.cat2 = _this.exam_marks[1].exam_marks === undefined ? [] : _this.exam_marks[1].exam_marks;
              var c = [];

              _this.cat2.filter(function (params) {
                c.push(params.mark);
                return c != null;
              });
            ...
            if (_this.exam_marks[2] !== undefined) {
              _this.cat3 = _this.exam_marks[2].exam_marks === undefined ? [] : _this.exam_marks[2].exam_marks;
              var c = [];

              _this.cat3.filter(function (params) {
                c.push(params.mark);
                return c != null;
              });
            ...
            if (_this.exam_marks[3] !== undefined) {
              _this.cat4 = _this.exam_marks[3].exam_marks === undefined ? [] : _this.exam_marks[3].exam_marks;
              var c = [];

              _this.cat4.filter(function (params) {
                c.push(params.mark);
                return c != null;
              });
            ...
            if (_this.exam_marks[4] !== undefined) {
              _this.cat5 = _this.exam_marks[4].exam_marks === undefined ? [] : _this.exam_marks[4].exam_marks;
              var c = [];

              _this.cat5.filter(function (params) {
                c.push(params.mark);
                return c != null;
              });
            ...
            if (_this.exam_marks[5] !== undefined) {
              _this.cat6 = _this.exam_marks[5].exam_marks === undefined ? [] : _this.exam_marks[5].exam_marks;
            }

            if (_this.exam_marks[6] !== undefined) {
              _this.cat7 = _this.exam_marks[6].exam_marks === undefined ? [] : _this.exam_marks[6].exam_marks;
            } //totals


            _this.total = _this.reportCards.totals[0].total_marks === undefined ? [] : _this.reportCards.totals[0].total_marks;
            _this.total = _this.total.filter(function (params) {
              return params.total !== null;
            }); //comments
            //positions

            if (_this.reportCards.calculation_mode === "Last Exam") {
              // this.this_term = this.reportCards.totals[0].total_marks[this.total.length - 1];
              //overall
              _this.overall = _this.reportCards.overall_marks_and_grade_by_last_exam; //position

              _this.positions = _this.reportCards.positions_by_last_exam;
            } else {
              _this.positions = _this.reportCards.positions;
              _this.overall = _this.reportCards.overall_marks_and_grade;
            } // set marks according to computation methods


            if (_this.reportCards.total_marks == null) {
              _this.this_term = [];
            } else {} //overage


            _this.avg = _this.reportCards.overall_marks_and_grade[0].this_term_marks_and_grade; // colSpan

            _this.colspan = 3 * _this.exam_type.length + 2;
            _this.comments = _this.reportCards.report_card_comments;
          }
        });
      }
      ...
      _createClass(GradesPage, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.authService.keys(this.student.school).subscribe(function (k) {
                      //console.log(k);
                      _this2.data = k;
                      _this2.keys = _this2.data.data;
                    });
        ...
        value: function open(file) {
          ...
          var fileMIMEType = this.getMIMEtype(fileExtn); // console.log(fileExtn, fileMIMEType, file);

          this.fileOpener.showOpenWithDialog(file, fileMIMEType).then(function () {
            return console.log('File is opened');
          })["catch"](function (e) {
            return console.log('Error openening file', e);
          });
        }
      }, {
        key: "formatDate",
        ...
        key: "format",
        value: function format(value) {// console.log(value);
    ...
    GradesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/reports/grades/grades.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./grades.page.scss */
      "./src/app/pages/reports/grades/grades.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_5__["FileOpener"], src_app_services_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"]])], GradesPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-reports-grades-grades-module-es5.js.map