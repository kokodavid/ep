...
/* harmony import */ var _blog_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blog.page */ "./src/app/pages/student/blog/blog.page.ts");
...
let BlogPage = class BlogPage {
    constructor(authService, route, router, session, alert) {
    ...
    ionViewWillEnter() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.authService.posts(this.student.school, this.student.student_id, 1).subscribe(posts => {
                // console.log(news);
                this.data = posts;
                this.posts = this.data.data.posts === undefined ? [] : this.data.data.posts;
            });
            yield this.authService.homeworks(this.student.school, this.student.student_id).subscribe(homeworks => {
...
BlogPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-blog',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./blog.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/student/blog/blog.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./blog.page.scss */ "./src/app/pages/student/blog/blog.page.scss")).default]
    }),
...
//# sourceMappingURL=pages-student-blog-blog-module-es2015.js.map