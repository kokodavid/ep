...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-student-fees-fees-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesStudentFeesFeesPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentFeesFeesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentFeesFeesPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentFeesFeesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function FeesPage(authService, route, router, session) {
        var _this = this;
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    _context.next = 4;
                    return this.authService.feesBalance(this.student.school, this.student.student_id).subscribe(function (balance) {
                      // console.log(news);
                      _this2.data = balance;
                      ...
                      if (_this2.data.nodata) {
                        ...
                        _this2.balance = _this2.data.data.fee_summary;
                        _this2.summary = _this2.data.data.fees;
                  ...
                  case 4:
                    _context.next = 6;
                    return this.authService.Feeitems(this.student.school, this.student.student_id).subscribe(function (feeitems) {
                      // console.log(homeworks.data);
                      _this2.data1 = feeitems;

                      if (_this2.data1.nodata) {
                        _this2.feeitems = [];
                      } else {
                        _this2.feeitems = _this2.data1.data;
                  ...
                  case 6:
                    _context.next = 8;
                    return this.authService.Invoices(this.student.school, this.student.student_id).subscribe(function (item) {
                      // console.log(news);
                      _this2.data4 = item;

                      if (_this2.data4.nodata) {
                        _this2.invoices = [];
                      } else {
                        var data = _this2.data4.data;
                        _this2.invoices = data.reverse();
                  ...
                  case 8:
                    _context.next = 10;
                    return this.authService.Payments(this.student.school, this.student.student_id).subscribe(function (items) {
                      // console.log(homeworks.data);
                      _this2.data3 = items;
                      console.log(_this2.data3);

                      if (_this2.data3.nodata) {
                        _this2.payments = [];
                      } else {
                        var data = _this2.data3.data;
                        _this2.payments = data.reverse();
    ...
    FeesPage.ctorParameters = function () {
      return [{
    ...
    FeesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/student/fees/fees.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./fees.page.scss */
      "./src/app/pages/student/fees/fees.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_services_session_service__WEBPACK_IMPORTED_MODULE_5__["SessionService"]])], FeesPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-student-fees-fees-module-es5.js.map