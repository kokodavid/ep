...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-auth-phone-phone-module"], {
  /***/
  ...
  /***/
  function node_modulesAngular2TextMask__ivy_ngcc__DistAngular2TextMaskJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  function srcAppMaskTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(Mask, [{
        ...
        value: function onInputChange(e) {
          try {
            ...
            for (var i = 0; i < value.length; i++) {
              ...
              if (i < pattern.length) {
                ...
                if (value[i] === pattern[ordinal]) {
                  applied += value[i];
                  ordinal++;
                } else if (reserve.indexOf(value[i]) > -1) {//skip other reserved characters
                } else {
                  ...
                  applied += value[i];
                  ordinal++; //apply trailing formatting
            ...
            if (this.model && this.model.valueAccessor) this.model.valueAccessor.writeValue(applied);
    ...
    Mask = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
      selector: '[mask]',
      host: {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"])()), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Attribute"])('mask')), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgModel"], String])], Mask);
    /***/
  },

  /***/
  "./src/app/pages/auth/phone/phone.module.ts":
  /*!**************************************************!*\
    !*** ./src/app/pages/auth/phone/phone.module.ts ***!
    \**************************************************/
  ...
  /***/
  function srcAppPagesAuthPhonePhoneModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PhonePageModule", function () {
    ...
    var angular2_text_mask__WEBPACK_IMPORTED_MODULE_5___default =
    /*#__PURE__*/
    __webpack_require__.n(angular2_text_mask__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    var _mask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../../mask */
    "./src/app/mask.ts");
    /* harmony import */


    var _phone_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./phone.page */
    "./src/app/pages/auth/phone/phone.page.ts");

    var routes = [{
      path: '',
      component: _phone_page__WEBPACK_IMPORTED_MODULE_8__["PhonePage"]
    }];

    var PhonePageModule = function PhonePageModule() {
      _classCallCheck(this, PhonePageModule);
    };

    PhonePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], angular2_text_mask__WEBPACK_IMPORTED_MODULE_5__["TextMaskModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes)],
      declarations: [_mask__WEBPACK_IMPORTED_MODULE_7__["Mask"]]
    })], PhonePageModule);
    /***/
  }
}]);
//# sourceMappingURL=pages-auth-phone-phone-module-es5.js.map