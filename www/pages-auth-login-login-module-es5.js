...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-auth-login-login-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesAuthLoginLoginPageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!-- <ion-header>\n  <ion-toolbar>\n    <ion-button color=\"light\" (click)=\"dismissLogin()\">Close</ion-button>\n    <ion-title>Login</ion-title>\n  </ion-toolbar>\n</ion-header> -->\n\n<ion-content class=\"ion-no-padding\">\n  <div class=\"main\">\n    <div style=\"height: 14%;\">\n    </div>\n    <div style=\"height:7%;\">\n      <div class=\"ion-text-center logo\">\n        <img src=\"../../../assets/logo/logo.png\" />\n      </div>\n    </div>\n    <div style=\"height: 27%;\">\n    </div>\n    <div style=\"margin-left: 8px; margin-right: 8px; background-color: white; border-radius: 5px;\">\n      <div style=\"margin-top: 20px; margin-bottom: 20px;\">\n        <form #form=\"ngForm\" (ngSubmit)=\"login(form)\" method=\"post\">\n          <ion-item style=\"margin-bottom: 5px;margin-top: 10px;\">\n            <ion-icon name=\"person\" slot=\"start\"></ion-icon>\n            <ion-input ngModel name=\"username\" type=\"text\" placeholder=\"Username\" value={{user}}></ion-input>\n          </ion-item>\n          <ion-item style=\"margin-bottom: 5px;margin-top: 10px;\">\n            <div tabindex=\"0\"></div>\n            <ion-icon name=\"lock-closed\" slot=\"start\"></ion-icon>\n            <ion-input ngModel type={{type}} name=\"password\" placeholder=\"Password\" value={{pass}}></ion-input>\n            <ion-icon ion-button *ngIf=\"showPasswordText == 1\" name=\"eye\" (click)=\"managePassword()\" slot=\"end\">\n            </ion-icon>\n            <ion-icon ion-button *ngIf=\"showPasswordText == 0\" name=\"eye-off\" (click)=\"managePassword()\" slot=\"end\">\n            </ion-icon>\n          </ion-item>\n          <ion-item lines=\"none\" style=\"font-size: 14px; font-weight: 500; box-shadow: none; \">\n            <div tabindex=\"0\"></div>\n            <ion-item lines=\"none\" style=\"font-size: 14px; font-weight: 500; box-shadow: none; \">\n              <input *ngIf=\"checked == 1\" type=\"checkbox\" style=\"width:20px;height:20px; \" ngModel name='remember'\n                (click)=\"check()\" checked=\"false\" slot=\"start\">\n              <input *ngIf=\"checked == 0\" type=\"checkbox\" stylkede=\"width:20px;height:20px;\" name='remember'\n                (click)=\"check()\" checked slot=\"start\">&nbsp;Remember Me\n            </ion-item>\n            <div (click)=\"forgot()\" style=\"color: rgb(35, 35, 218); text-align: center; \" slot=\"end\">Forgot Password?\n            </div>\n          </ion-item>\n          <ion-item lines=\"none\" style=\"font-size: 14px; font-weight: 500; box-shadow: none;\">\n            <div tabindex=\"0\"></div>\n            <ion-button type=\"submit\" size=\"large\"\n              style=\"background-color: #397C49; border-radius: 4px; font-weight: 500; font-size: 16px; margin-left:auto; margin-right:auto; margin-bottom: 12px; width: 100%;\"\n              expand=\"block\">LOGIN</ion-button>\n\n          </ion-item>\n          <ion-item lines=\"none\" (click)=\"phone()\">\n            <div tabindex=\"0\"></div> \n            <ion-text ion-button\n              style=\"color: rgb(35, 35, 218); border-bottom: 1px; text-align: center; font-size: 16px; font-weight: 500; margin-left:auto; margin-right:auto; margin-bottom: 20px;\">\n              Or register new Account <ion-icon style=\"font-size: 14px;margin-top: 5px; color: rgb(35, 35, 218);\"\n                name=\"arrow-forward\"></ion-icon>\n            </ion-text> \n\n          </ion-item>\n        </form>\n      </div>\n    </div>\n  </div>\n\n</ion-content>";
    /***/
  },
  ...
  function srcAppPagesAuthLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _phone_phone_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../phone/phone.page */
    ...
    LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes)],
      // declarations: [LandingPage, LoginPage, RegisterPage],
      entryComponents: [_login_page__WEBPACK_IMPORTED_MODULE_8__["LoginPage"], _phone_phone_page__WEBPACK_IMPORTED_MODULE_5__["PhonePage"], _forgot_password_forgot_password_page__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordPage"]],
      declarations: [_login_page__WEBPACK_IMPORTED_MODULE_8__["LoginPage"], _forgot_password_forgot_password_page__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordPage"], _phone_phone_page__WEBPACK_IMPORTED_MODULE_5__["PhonePage"]],
      providers: [_ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_9__["Device"]]
    })], LoginPageModule);
    /***/
  },
  ...
  function srcAppPagesAuthLoginLoginPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".main {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  background-color: #397C49;\n}\n\n@media screen and (min-width: 767px) {\n  ion-card {\n    width: 600px;\n  }\n}\n\nion-card {\n  --background: #fff;\n  border-radius: 0px;\n  margin: 0px;\n  width: 100%;\n}\n\nion-icon {\n  color: #000000;\n  font-size: 1.7em;\n  margin-right: 10px;\n}\n\nbody.keyboard-open.platform-ios .bar-footer {\n  bottom: 36px;\n}\n\n.center {\n  text-align: center;\n  margin-top: 20px;\n  margin-bottom: 35px;\n}\n\nion-content {\n  --ion-background-color:#397C49;\n}\n\nion-content .logo {\n  max-width: 80%;\n  height: 70px;\n  margin: auto;\n}\n\nion-input {\n  background: #fff;\n  width: 100%;\n  border-bottom: black;\n}\n\nion-grid {\n  margin-top: 80px;\n  width: 100%;\n  height: 50%;\n  background: #fff;\n  margin-bottom: 30px;\n}\n\nion-row {\n  height: 50%;\n  background: #fff;\n  width: 100%;\n}\n\nion-label {\n  font-size: 12px;\n}\n\nion-col {\n  border: 1px solid #488aff;\n  background: #fff;\n  width: 100%;\n}\n\nion-button {\n  font-weight: 300;\n  background-color: darkgreen;\n}\n\nion-item {\n  --ion-item-background:$white-color;\n  width: 100%;\n}\n\nion-item.item:hover a {\n  background-color: white;\n  box-shadow: inset 0px 0px 0px 1px white;\n}\n\n@media (min-width: 240px) and (max-width: 768px) {\n  ion-grid {\n    background: #fff;\n  }\n\n  ion-col {\n    border: none;\n  }\n}\n\n.button.button-gold {\n  border-color: transparent;\n  background-color: #625031;\n  color: #000000;\n}\n\n.button.button-gold:hover {\n  color: #000000;\n  text-decoration: none;\n}\n\n.button.button-gold.active, .button.button-gold.activated {\n  background-color: #c0a062;\n}\n\n.button.button-gold.button-clear {\n  border-color: transparent;\n  background: none;\n  box-shadow: none;\n  color: #625031;\n}\n\n.button.button-gold.button-icon {\n  border-color: transparent;\n  background: none;\n}\n\n.button.button-gold.button-outline {\n  border-color: #625031;\n  background: transparent;\n  color: #625031;\n}\n\n.button.button-gold.button-outline.active, .button.button-gold.button-outline.activated {\n  background-color: #625031;\n  box-shadow: none;\n  color: #000000;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _phone_phone_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../phone/phone.page */
    "./src/app/pages/auth/phone/phone.page.ts");
    /* harmony import */
    ...
    var _services_env_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var SplashScreen = _capacitor_core__WEBPACK_IMPORTED_MODULE_12__["Plugins"].SplashScreen;

    var LoginPage =
    /*#__PURE__*/
    function () {
      function LoginPage(modalController, authService, navCtrl, alertService, menu, spinnerDialog, toastController, uniqueDeviceID, http, env, device, router, alertCtrl) {
      ...
      _createClass(LoginPage, [{
        ...
        key: "managePassword",
        value: function managePassword() {
          if (this.showPasswordText === 0) {
            this.showPasswordText = 1;
            this.type = 'text'; // console.log(this.showPasswordText);
          } else if (this.showPasswordText === 1) {
            this.showPasswordText = 0;
            this.type = 'password'; // console.log(this.showPasswordText);
          }
        }
      }, {
        key: "check",
        value: function check() {
          ...
          console.log(c); // console.log(stat);
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return this.modalController.create({
                      component: _phone_phone_page__WEBPACK_IMPORTED_MODULE_3__["PhonePage"]
                    });

                  case 3:
                    phoneModal = _context.sent;
                    this.authService.dismiss();
                    _context.next = 7;
                    return phoneModal.present();
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    forgotModal = _context2.sent;
                    this.authService.dismiss();
                    _context2.next = 7;
                    return forgotModal.present();
        ...
        value: function login(form) {
          ...
          var device_id = localStorage.getItem('id'); // if (device_id != null && device_id.length>30) {

          this.authService.login(form.value.username, form.value.password, device_id).subscribe(function (data) {
            _this2.data = data;
            console.log(_this2.data);

            if (_this2.data.response === 'success') {
              _this2.students = _this2.data.data.students; // console.log(JSON.stringify(this.students));
              ...
              if (_this2.students.length === 0) {
                ...
                var navigationExtras = {
                  state: {
                    details: _this2.data.data.resources
                  }
                };

                _this2.router.navigate(['dashboard'], navigationExtras);
              }
            } else {
              _this2.presentAlert2(_this2.data.data); // console.log('success but no redirection');
            ...
            _this2.presentAlert2("Inactive user. Please contact respective school for more information.");
          }, function () {//this.navCtrl.navigateRoot('/dashboard');
          }); // }else{
    ...
    LoginPage.ctorParameters = function () {
      return [{
        ...
        type: _services_env_service__WEBPACK_IMPORTED_MODULE_10__["EnvService"]
      }, {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_6__["AlertService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _ionic_native_spinner_dialog_ngx__WEBPACK_IMPORTED_MODULE_7__["SpinnerDialog"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"], _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_8__["UniqueDeviceID"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClient"], _services_env_service__WEBPACK_IMPORTED_MODULE_10__["EnvService"], _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_11__["Device"], _angular_router__WEBPACK_IMPORTED_MODULE_13__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"]])], LoginPage);
    /***/
  }
}]);
