...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-auth-forgot-password-forgot-password-module~pages-auth-login-login-module"], {
  ...
  function srcAppPagesAuthForgotPasswordForgotPasswordPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ForgotPasswordPage( //private keyboard: Keyboard,
      ...
      _createClass(ForgotPasswordPage, [{
        ...
        value: function check(form) {
          ...
          this.authService.checkforgot(ph).subscribe(function (data) {
            _this.data = data;
            console.log(_this.data.response);

            if (_this.data.response === 'Success') {
              _this.code = 1;
              _this.phone = form.value.phone; // const temp_code = String(this.data.temporary-code);
            } else if (_this.data.status.includes("SMS resent")) {
              _this.errmsg(_this.data.message);
            ...
            console.log(error); // this.errmsg('Error occured while trying to reset your password  please try again later...');
            // console.log(error);
          });
        }
      }, {
        key: "errmsg",
        value: function errmsg(info) {
        ...
        value: function verify(form) {
          ...
          ;
          this.authService.verifypassword(form.value.code, ph).subscribe(function (data) {
            _this2.data = data;

            if (_this2.data.response === 'Success') {
              console.log(form.value);

              _this2.authService.login(ph, form.value.code, _this2.deviceid).subscribe(function (res) {
                // console.log(data);
                _this2.data = res;
                ...
                if (_this2.data.response === 'success') {
                  ...
                  if (ph) {
                    var creds = {
                      ...
                      device_user_id: _this2.deviceid
                    };
        ...
        value: function register(form) {
          ...
          if (form.value.pass === form.value.repass) {
            console.log(form.value);
            this.authService.registerPwd(form.value.pass, this.phone).subscribe(function (data) {
              _this3.data = data;

              if (_this3.data.response === 'sucesss') {
                _this3.dismissRegister(); // this.code = 2;
        ...
        value: function resend() {
          ...
          this.authService.resend(this.phone).subscribe(function (data) {
            _this4.data = data;

            if (_this4.data.response === 'success') {
              _this4.code = 1;

              _this4.errmsg(_this4.data.response);
            } else {
              _this4.errmsg(_this4.data.response);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"], _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_5__["Device"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_6__["UniqueDeviceID"]])], ForgotPasswordPage);
    /***/
  }
}]);
//# sourceMappingURL=default~pages-auth-forgot-password-forgot-password-module~pages-auth-login-login-module-es5.js.map