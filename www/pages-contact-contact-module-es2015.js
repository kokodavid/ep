...
/* harmony import */ var _contact_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./contact.page */ "./src/app/pages/contact/contact.page.ts");
...
let ContactPage = class ContactPage {
    constructor(router, route, authService, alertService) {
        this.router = router;
        this.route = route;
    ...
    ionViewWillEnter() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.authService.schoolInfo(this.school_subdomain).subscribe(info => {
                this.data = info;
