...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-student-analytics-analytics-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAnalyticsModalAnalyticsModalComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesStudentAnalyticsAnalyticsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAnalyticsModalAnalyticsModalComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAnalyticsModalAnalyticsModalComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AnalyticsModalComponent", function () {
    ...
    var AnalyticsModalComponent =
    /*#__PURE__*/
    function () {
      function AnalyticsModalComponent(modalCtl, navParams, authService) {
        _classCallCheck(this, AnalyticsModalComponent);
      ...
      _createClass(AnalyticsModalComponent, [{
        key: "ngOnInit",
        ...
        value: function createChart() {
          var reportCards;
          reportCards = new Array(); // this.reportCards = new Array();
          ...
          var exam = []; // tslint:disable-next-line:prefer-for-of

          for (var a = 0; a < this.exam_marks.length; a++) {
            // tslint:disable-next-line: prefer-for-of
            for (var b = 0; b < this.exam_marks[a].exam_marks.length; b++) {
          ...
          for (var i = 0; i < this.exam_marks.length; i++) {
            ...
            _a = underscore__WEBPACK_IMPORTED_MODULE_4__["sortBy"](this.exam_marks[i].exam_marks, 'subject_name');
            _a = _a.filter(function (param) {
              var sub_id = [];
              sub_id = param.parent_subject_id;
              return sub_id == null;
            });
            this.math.push(_a[0].mark);
            this.english.push(_a[1].mark);
            this.kiswahili.push(_a[2].mark);
            this.science.push(_a[3].mark);
            this.ssre.push(_a[4].mark);
          }
          ...
          for (var j = 0; j < this.exam_marks[0].exam_marks.length; j++) {
            ...
            _b = underscore__WEBPACK_IMPORTED_MODULE_4__["sortBy"](this.exam_marks[0].exam_marks, 'subject_name');

            if (_b[j].parent_subject_id == null) {
              subjects.push(_b[j].subject_name);
            }
          }

          if (this.terms != undefined || this.terms != null) {
            this.math = this.math.filter(function (el) {
              return el != null;
            });
            this.english = this.english.filter(function (el) {
              return el != null;
            });
            this.kiswahili = this.kiswahili.filter(function (el) {
              return el != null;
            });
            this.science = this.science.filter(function (el) {
              return el != null;
            });
            this.ssre = this.ssre.filter(function (el) {
              return el != null;
            });
        ...
        key: "overallChart",
        value: function overallChart() {
          var ovMarks = [];
          var termNames = [];
          this.labels = this.labels;

          for (var i = 0; i < this.labels.length; i++) {
            ovMarks.push(this.labels[i].overall_marks_and_grade[0].this_term_marks_and_grade[0].overall_mark.substr(0, 3));
    ...
    AnalyticsModalComponent.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('barChart'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsModalComponent.prototype, "barChart", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('lineChart'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsModalComponent.prototype, "ovChart", void 0);
    AnalyticsModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-analytics-modal',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./analytics-modal.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/analytics-modal/analytics-modal.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./analytics-modal.component.scss */
      "./src/app/analytics-modal/analytics-modal.component.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"], _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]])], AnalyticsModalComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesStudentAnalyticsAnalyticsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_analytics_modal_analytics_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/analytics-modal/analytics-modal.component */
    "./src/app/analytics-modal/analytics-modal.component.ts");
  ...
  /***/
  function srcAppPagesStudentAnalyticsAnalyticsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesStudentAnalyticsAnalyticsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_analytics_modal_analytics_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/analytics-modal/analytics-modal.component */
    "./src/app/analytics-modal/analytics-modal.component.ts");
    ...
    /*#__PURE__*/
    function () {
      function AnalyticsPage(authService, route, router, session, modalCtl) {
        var _this2 = this;
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this2.router.getCurrentNavigation().extras.state) {
            _this2.student = _this2.router.getCurrentNavigation().extras.state.details; // console.log(this.student);

            _this2.assets = _this2.student.student_image === null ? 1 : "https://".concat(_this2.student.school, ".eduweb.co.ke/assets/students/").concat(_this2.student.student_image);
          }
        });
        this.options = {
          title: {
      ...
      _createClass(AnalyticsPage, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.authService.cards(this.student.school, this.student.student_id).subscribe(function (cards) {
                      _this3.data = cards;
                      _this3.labels = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](_this3.data.data, 'term_id');
                      var n = [];

                      for (var i = 0; i < _this3.labels.length; i++) {
                        n = _this3.labels[i].exam_marks;
                      }

                      if (_this3.labels == undefined || _this3.labels.length === 0 || n === null) {
                        _this3.nodata = 'true';

                        _this3.authService.dismiss();
                      } else {
                        _this3.nodata = 'false';
                        _this3.report_cards = _this3.labels.reverse();
                        console.log(_this3.report_cards); //display latest cards only

                        if (_this3.report_cards[0].year === '2020') {
                          _this3.sort = 1;
                          _this3.report_cards = _this3.report_cards.filter(function (x) {
                            return x.year == '2020';
                          });
                        } else if (_this3.report_cards[0].year === '2019') {
                          _this3.sort = 0;
                          _this3.report_cards = _this3.report_cards.filter(function (y) {
                            return y.year == '2019';
                          });
                        } else if (_this3.report_cards[0].year === '2018') {
                          _this3.sort = 0;
                          _this3.report_cards = _this3.report_cards.filter(function (y) {
                            return y.year == '2018';
                          });
                  ...
                  case 2:
                    ...
                    return this.authService.schoolTerm(this.student.school, this.student.student_id).subscribe(function (school_terms) {
                      _this3.data = school_terms;
                      _this3.terms = _this3.data.data;
                      _this3.class_history = _this3.terms.map(function (item) {
        ...
        key: "reportData",
        value: function reportData(report) {
        ...
        value: function hide() {
          ...
          if (this.hidden == true) {
            ...
            if (this.report_cards[0].year === '2020') {
              this.sort = 1;
              this.report_cards = this.report_cards.filter(function (params) {
                return params.year == '2020';
              });
            } else {
              this.sort = 0;
              this.report_cards = this.report_cards.filter(function (y) {
                return y.year == '2019';
              });
            }
        ...
        value: function filter() {
          ...
          this.report_cards = this.data.data === undefined ? [] : this.data.data; //find index of the report_cards in reportcards

          var c;
          c = this.report_cards.filter(function (reports) {
            var j = [];
            j = reports.term_id;
            return j == _this6.t_id;
          });
          console.log(c[0]);
          ...
          setTimeout(function () {
            _this6.createChart(_this6.pos);
          }, 2000);
        } // chart 

      }, {
        key: "createChart",
        value: function createChart(pos) {
          console.log(pos);

          if (pos != -1) {
            var term1 = this.report_cards[0].exam_marks;
            var type1 = [];

            for (var _h = 0; _h < term1.length; _h++) {
              type1.push(term1[_h].exam_type);
            }
            ...
            var _term = this.exam_marks[0];
            var term2 = this.exam_marks[1];
            var term3 = this.exam_marks[2];
            console.log(_term[0].exam_marks); //subjects

            var _subjects = [];

            for (var n = 0; n < _term[0].exam_marks.length; n++) {
              var _b2 = void 0;

              _b2 = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](_term[0].exam_marks, 'subject_name');

              if (_b2[n].parent_subject_id == null) {
                _subjects.push(_b2[n].subject_name);
              }
            }

            this.terms = []; //exam types

            var _type = [];
            var type2 = [];
            var type3 = []; // exam types

            for (var h = 0; h < _term.length; h++) {
              _type.push(_term[h].exam_type);
            }
            ...
            for (var _i = 0; _i < _term.length; _i++) {
              _a2 = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](_term[_i].exam_marks, 'subject_name');
              _a2 = _a2.filter(function (param) {
                var sub_id = [];
                sub_id = param.parent_subject_id;
                return sub_id == null;
              });
              this.math.push(_a2[0].mark);
              this.english.push(_a2[1].mark);
              this.kiswahli.push(_a2[2].mark);
              this.science.push(_a2[3].mark);
              this.ssre.push(_a2[4].mark);
            }
            ...
            if (term2 !== undefined || [] || term3 !== undefined || []) {
              //exam types
              for (var l = 0; l < term2.length; l++) {
                type2.push(term2[l].exam_type);
              }

              if (term3 !== undefined) {
                for (var m = 0; m < term3.length; m++) {
              ...
              for (var i = 0; i < term2.length; i++) {
                _a3 = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](term2[i].exam_marks, 'subject_name');
                _a3 = _a3.filter(function (param) {
                  var sub_id = [];
                  sub_id = param.parent_subject_id;
                  return sub_id == null;
                });
                math2.push(_a3[0].mark);
                eng2.push(_a3[1].mark);
                kis2.push(_a3[2].mark);
                sci2.push(_a3[3].mark);
                ssre2.push(_a3[4].mark);
              } //term 3
              ...
              if (term3 !== undefined) {
                for (var i = 0; i < term3.length; i++) {
                  ...
                  _a4 = underscore__WEBPACK_IMPORTED_MODULE_7__["sortBy"](term3[i].exam_marks, 'subject_name');
                  _a4 = _a4.filter(function (param) {
                    var sub_id = [];
                    sub_id = param.parent_subject_id;
                    return sub_id == null;
                  });
                  math3.push(_a4[0].mark);
                  eng3.push(_a4[1].mark);
                  kis3.push(_a4[2].mark);
                  sci3.push(_a4[3].mark);
                  ssre3.push(_a4[4].mark);
                }
              }

              math2 = math2.filter(function (el) {
                return el != null;
              });
              eng2 = eng2.filter(function (el) {
                return el != null;
              });
              kis2 = kis2.filter(function (el) {
                return el != null;
              });
              sci2 = sci2.filter(function (el) {
                return el != null;
              });
              ssre2 = ssre2.filter(function (el) {
                return el != null;
              });
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('lineChart'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsPage.prototype, "lineChart", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('lineChart2'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsPage.prototype, "lineChart2", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('lineChart3'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsPage.prototype, "lineChart3", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('overallChart'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], AnalyticsPage.prototype, "ovChart", void 0);
    AnalyticsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/student/analytics/analytics.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./analytics.page.scss */
      "./src/app/pages/student/analytics/analytics.page.scss"))["default"]]
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_services_session_service__WEBPACK_IMPORTED_MODULE_5__["SessionService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ModalController"]])], AnalyticsPage);
    /***/
  }
}]);
//# sourceMappingURL=pages-student-analytics-analytics-module-es5.js.map