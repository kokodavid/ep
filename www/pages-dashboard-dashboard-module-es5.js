...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-dashboard-dashboard-module"], {
  ...
  function srcAppPagesDashboardDashboardPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js"); // import { User } from 'src/app/models/user';


    var DashboardPage =
    /*#__PURE__*/
    function () {
      function DashboardPage(spinnerDialog, // private apiService: ApiService,
      router, spinner, dataService, menu, authService, sessionService, loadingController, alertCtrl, http, route) {
        ...
        this.route.queryParams.subscribe(function (params) {
          if (_this.router.getCurrentNavigation().extras.state) {
            _this.resources = _this.router.getCurrentNavigation().extras.state.details; // console.log(JSON.stringify(this.resources))
          }
        });
      ...
      _createClass(DashboardPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    user = _context.sent;
                    u = JSON.parse(user);
                    this.userinfo = u; // console.log(JSON.stringify(this.userinfo));

                    this.students = this.userinfo.students === undefined ? [] : this.userinfo.students;
                    this.school = this.students[0].school;
                    parent = this.userinfo.parent_id === undefined ? {} : this.userinfo.parent_id; // $(document).ready(function() {
                    //   $.ajax({
                    //     type: 'GET',
                    ...
                    return this.authService.news().subscribe(function (news) {
                      _this2.data = news;
                      _this2.news = _this2.data.data.news[_this2.school] !== undefined ? _this2.data.data.news[_this2.school] : [];
                      _this2.assets = "https://".concat(_this2.school, ".eduweb.co.ke/assets/students/");
                    });
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 5:
                    ...
                    return this.authService.news().subscribe(function (news) {
                      _this3.data = news;
                      _this3.news = _this3.data.data.news[_this3.school] !== undefined ? _this3.data.data.news[_this3.school] : [];
                      _this3.assets = "https://".concat(_this3.school, ".eduweb.co.ke/assets/students/");
                    });
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 3;
                    return this.authService.reloadnews().subscribe(function (news) {
                      _this4.authService.dismiss(); // console.log(news);


                      _this4.data = news;
                      _this4.news = _this4.data.data.news[_this4.school] !== undefined ? _this4.data.data.news[_this4.school] : [];
                      console.log("okayokay" + JSON.stringify(_this4.news));
                      _this4.assets = "https://".concat(_this4.school, ".eduweb.co.ke/assets/students/");
                    });
        ...
        key: "newsInfo",
        value: function newsInfo(news, school) {
          // console.log(news);
          var navigationExtras = {
            state: {
              details: news,
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_spinner_dialog_ngx__WEBPACK_IMPORTED_MODULE_8__["SpinnerDialog"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], ngx_spinner__WEBPACK_IMPORTED_MODULE_7__["NgxSpinnerService"], _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["MenuController"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], src_app_services_session_service__WEBPACK_IMPORTED_MODULE_9__["SessionService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], DashboardPage);
    /***/
  }
}]);
